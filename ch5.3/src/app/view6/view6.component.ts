import { CUSTOM_ELEMENTS_SCHEMA, Component, OnInit,NgModule } from '@angular/core';
...
@Component({
  selector: 'app-view6',
  standalone: true,
  imports: [CommonModule , MatButtonModule, ScrollingModule,RouterOutlet, NgxMaterialTimepickerModule],
  templateUrl: './view6.component.html',
  styleUrl: './view6.component.scss',
  schemas: [CUSTOM_ELEMENTS_SCHEMA]
})
export class View6Component implements OnInit {
  constructor(public dialog: MatDialog, public rout: ChRouteServiceService) { }
  ...
  newTime: string[] = ["1,Sensor Override ON,0,22,XXXXXXX,XXXXXXXXXXXX,0,,11152021:002105,", "1", "2", "3", "4", "5", "6", "7"];
  value: string;
  evt: string[] = ["Sch.ET0", "Sch.ET1", "Sch.ET2", "Sch.ET3", "Sch.ET4", "Sch.ET5", "Sch.ET6", "Sch.ET7"];
  evtf: string[] = ["Sch.ETF0", "Sch.ETF1", "Sch.ETF2", "Sch.ETF3", "Sch.ETF4", "Sch.ETF5", "Sch.ETF6", "Sch.ETF7"];
  ngOnInit(): void {
